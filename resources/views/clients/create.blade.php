...
@section('title', 'Nuevo Cliente - TurneroPro')

@section('content')
    <div class="mb-6">
        <h1 class="text-3xl font-bold">Nuevo Cliente</h1>
    </div>

    <form method="POST" action="{{ route('clients.store') }}" class="max-w-xl space-y-5">
        @csrf
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('clients.index') }}" class="text-sm hover:underline">Cancelar</a>
        </div>
    </form>
@endsection