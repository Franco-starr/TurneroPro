...
@section('content')
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <a href="{{ route('services.create') }}" class="rounded-sm bg-green-600 px-5 py-2 text-sm text-white hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-700 dark:text-white">
            Nuevo Servicio
        </a>
    </div>
